  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 md:px-8 md:py-32 lg:py-40">
          <div className="text-center">
            {/* メインタイトル */}
            <h1 className="mb-6 text-5xl font-light tracking-tight text-gray-900 sm:text-6xl md:text-7xl lg:text-8xl">
              <span className="block whitespace-nowrap">あなたの理想の紹介ページを、</span>
              <span className="block mt-2 whitespace-nowrap">最速で公開。</span>
          </h1>

            {/* キャッチフレーズ */}
            <p className="mb-10 text-lg font-light text-gray-600 sm:mb-12 sm:text-xl md:text-2xl">
            名刺以上、Web未満。
          </p>
            ...
            <SignUpButton mode="modal" fallbackRedirectUrl="/top">
                <button className="inline-flex items-center gap-2 rounded-md bg-gray-900 px-6 py-3 text-base font-medium text-white transition-colors hover:bg-gray-800 sm:px-8 sm:py-4 sm:text-lg">
        ...
        {/* サンプルセクション */}
        <section id="sample" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 md:px-8 md:py-32">
          <div className="text-center mb-16 sm:mb-20">
            <h2 className="text-4xl font-light text-gray-900 sm:text-5xl md:text-6xl">
              完成イメージ
            </h2>
          </div>
        ...
        {/* 特徴セクション */}
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 md:px-8 md:py-32">
          <div className="text-center mb-16 sm:mb-20">
            <h2 className="text-4xl font-light text-gray-900 sm:text-5xl md:text-6xl mb-6">
              コードを書かずに<br />
              構築、公開、運用まで<br />
              Meishi+で完結。
            </h2>
            <p className="mx-auto max-w-3xl text-lg text-gray-600 sm:text-xl md:text-2xl">
              AI搭載のエディタで、自由に紹介ページを構築。<br />
              ワンクリックでスピーディに公開。第三者が安心して紹介できるプロフィールを簡単に作成できます。
            </p>
          </div>

          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 sm:gap-12">
            {/* 特徴カード1 */}
            <div className="border-t border-gray-200 pt-8">
              <h3 className="mb-4 text-2xl font-light text-gray-900 sm:text-3xl">10分で完成</h3>
            ...
            {/* 特徴カード2 */}
            <div className="border-t border-gray-200 pt-8">
              <h3 className="mb-4 text-2xl font-light text-gray-900 sm:text-3xl">営業臭ゼロ</h3>
              <p className="text-base leading-relaxed text-gray-600 sm:text-lg">
            ...
            {/* 特徴カード3 */}
            <div className="border-t border-gray-200 pt-8 sm:col-span-2 lg:col-span-1">
              <h3 className="mb-4 text-2xl font-light text-gray-900 sm:text-3xl">人となりを伝える</h3>
              <p className="text-base leading-relaxed text-gray-600 sm:text-lg">
        ...
        {/* FAQ Section */}
        <section id="faq" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 md:px-8 md:py-32">
          <div className="text-center mb-16 sm:mb-20">
            <h2 className="text-4xl font-light text-gray-900 sm:text-5xl md:text-6xl mb-6">
              よくある質問
          </h2>
          ...
          <div className="mx-auto max-w-4xl space-y-8 sm:space-y-12">
            <div className="border-t border-gray-200 pt-8">
              <h3 className="mb-4 text-2xl font-light text-gray-900 sm:text-3xl">
                Meishi+ とは何ですか？
              </h3>
